        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                foreach($users_list as $ul){
                    ...
                    echo '<td class="text-center">'.(($ul['roles'] & FARMER) ? '<i class="fa fa-check-circle-o text-success"></i>' : '<i class="fa fa-minus-circle text-danger"></i>').'</td>';
                    echo '<td class="text-center">'.(($ul['roles'] & FACTORY) ? '<i class="fa fa-check-circle-o text-success"></i>' : '<i class="fa fa-minus-circle text-danger"></i>').'</td>';
                    echo '<td class="text-center">'.(($ul['roles'] & PACKER) ? '<i class="fa fa-check-circle-o text-success"></i>' : '<i class="fa fa-minus-circle text-danger"></i>').'</td>';
                    echo '<td class="text-center">'.(($ul['roles'] & RETAIL) ? '<i class="fa fa-check-circle-o text-success"></i>' : '<i class="fa fa-minus-circle text-danger"></i>').'</td>';
                    if($ul['roles'] & ADMIN){
                        echo '<td></td>';
                    } else {
