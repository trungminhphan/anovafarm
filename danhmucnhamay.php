	...
	<div class="col-md-12">
		<div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-list"></i> Danh mục nhà máy</h4>
            </div>
            		...
            		if($danhmucnhamay_list){
            			...
            			foreach ($danhmucnhamay_list as $dm) {
            				...
            				echo '<tr>
                                ...
                                <td>'.$dm['ten'].'</td>
	            				<td>'.$dm['diachi'].'</td>
	            				<td class="text-center"><a href="get.danhmucnhamay.html?id='.$dm['_id'].'&act=del" onclick="return confirm(\'Chắc chắn muốn xoá?\');"><i class="fa fa-trash"></i></a></td>
	            				<td class="text-center"><a href="get.danhmucnhamay.html?id='.$dm['_id'].'&act=edit#modal-dmnhamay" data-toggle="modal" class="suadmnhamay"><i class="fa fa-pencil"></i></a></td>
	            			</tr>';$i++;
            			}
            		}
            		?>
...
<form action="post.danhmucnhamay.html" method="POST" class="form-horizontal" data-parsley-validate="true" name="nhamayform">
