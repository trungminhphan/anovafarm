            ...
            <ul class="nav">
            	...
            	<li class="has-sub">
	                <a href="#">
	                 ...
	                 <ul class="sub-menu">
	                 	<li class="divider"></li>
                        <li><a href="danhmuccongty.html">Công ty</a></li>
                        <li class="divider"></li>
                        <li><a href="danhmucnongtrai.html">Nông trại</a></li>
                        <li class="divider"></li>
                        <li><a href="danhmucnhamay.html">Nơi giết mổ, Đóng gói, Sơ Chế</a></li>
                        <li class="divider"></li>
                        <li><a href="danhmucbanle.html">Nơi bán lẻ</a></li>
                        <li class="divider"></li>
                    </ul>
                </li>
                <?php endif; ?>
