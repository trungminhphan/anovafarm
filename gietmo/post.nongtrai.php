...
$gioxuat = isset($_POST['gioxuat']) ? $_POST['gioxuat'] : '';
$phutxuat = isset($_POST['phutxuat']) ? $_POST['phutxuat'] : 0;
$ngaygioxuat = new MongoDate(convert_date_yyyy_mm_dd_1($ngaygioxuat, $gioxuat, $phutxuat));
