...
class BanLeTrung {
	...
	public function __construct(){
		...
		$this->_collection = $this->_mongo->banletrung;
	}
	...
	public function insert(){
		$query = array(
			'id_donggoitrung' => DBConnect::ObjectId($this->id_donggoitrung),
	...
	public function check_donggoi($id_donggoitrung){
		$query = array('id_donggoitrung' => DBConnect::ObjectId($id_donggoitrung));
	...
	public function search_by_congty($search){
		...
		$query = array('$or' => array(
			...
			array('id_donggoitrung' => array('$in' => $arr_donggoi))
		));
