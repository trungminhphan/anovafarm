...
class BanLeRauQua {
	...
	public function __construct(){
		...
		$this->_collection = $this->_mongo->banlerauqua;
	}
	...
	public function insert(){
		$query = array(
			'id_donggoirauqua' => DBConnect::ObjectId($this->id_donggoirauqua),
	...
	public function check_donggoi($id_donggoirauqua){
		$query = array('id_donggoirauqua' => DBConnect::ObjectId($id_donggoirauqua));
