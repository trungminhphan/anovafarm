...
class GridFS{
	...
	public function __construct(){
		...
		$this->_gridfs = $this->_mongo->selectGridFSBucket();
	}
	public function insert_files(){
		$id = $this->_gridfs->openUploadStream($this->tmpfilepath, array('filename' => $this->filename, 'filetype' => $this->filetype, 'caption' => $this->caption));
		return $id;
	}
