<?php
class NongTraiTrung {
	const COLLECTION = 'nongtraitrung';
	private $_mongo;
	private $_collection;
	...
	public function __construct(){
		...
		$this->_collection = $this->_mongo->getCollection(NongTraiTrung::COLLECTION);
	}
	...
	public function search($search){
		...
		$query = array( '$or' => array(
			...
			array('nhamaycungcapthucan' => new MongoRegex('/' . $search . '/i')),
