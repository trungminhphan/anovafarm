...
echo '<div class="qrcode_area_trung" id="qrcode_trung">';
	echo '<img src="'.$PNG_WEB_DIR.basename($filename).'" class="qrcode_img_trung" />';  
	echo '<div class="title_qrcode_trung"><span>'.$tensanpham.'</span></div>';
	echo '<div class="content_qrcode_trung">
		<p>Quy cách: '.$quicachdonggoi.'</p>
		<p>Ngày đóng gói: '.$ngaydonggoi.'</p>
		<p>Hạn sử dụng: '.$hansudung.'</p>
	</div>';
	echo '<div class="title_qrcode_1_trung">CTY CP CO-OP  NOVA SAFE FOODS</div>';
echo '</div>';
//<p>Quy cách: '.$quicachdonggoi.'</p>
